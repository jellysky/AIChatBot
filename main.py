import langchain, openai, chainlit, chromadb, tiktoken, PyPDF2, langchain_community
...
async def on_chat_start():
    ...
    elements = [
    cl.Image(name="image1", display="inline", path=".im/robot.jpg")
    ]
    ...
    #file = 'Jardine_2014_Environ._Res._Lett._9_104013.pdf'
